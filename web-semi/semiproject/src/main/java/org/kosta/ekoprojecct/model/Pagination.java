...
public class Pagination {
	 ...
	 * 이전 페이지 마지막 번호 + 1 <br>
	 * 2페이지의 시작번호는 1페이지의 마지막번호5 + 1 이 시작 번호가 된다. 5라는 값은 postCountPerPage <br>
	 ...
	 * 총 페이지 수를 반환 <br>
	 * 
	 * totalPageCount/postCountPerPage 연산값의 나머지가 0이면 나눈값이 총페이지 수
	 * totalPageCount/postCountPerPage 연산값의 나머지가 0이 아니면 나눈값+1이 총페이지 수
	 * 
	 ...
	 * 
	 * 이전페이지그룹 * pageCountPerPageGroup + 1 <br>
	 * 
